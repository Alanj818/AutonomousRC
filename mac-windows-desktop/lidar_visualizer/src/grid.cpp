...
grid::grid(float cell_size, sf::Vector2u window_size) : cell_size(cell_size), window_size(window_size), cell_state( static_cast<int>(window_size.y / cell_size), std::vector<cellData>(static_cast<int>(window_size.x / cell_size), cellData::Free)) {}
